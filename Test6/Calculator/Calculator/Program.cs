...
namespace Calculator
{
    ...
    public class Functions : ICalculator
    {
        ...
        {
            int result = 0;
            List<int> errArray = new List<int>();

            if (!string.IsNullOrEmpty(arg))
            {
                // Calling string extension 
                ...
                else
                {
                    ...
                    // splitting with multiple string
                    ...
                    if (errArray.Count > 0)
                    {
                        throw new Exception(string.Format("Negative numbers ({0}) not allowed.", ReturnArray(errArray)));
                    }
                }
        ...
        /// <summary>
        /// Convert the list of number to string and return
        /// </summary>
        /// <param name="array"></param>
        /// <returns></returns>
        private static string ReturnArray(List<int> array)
        {
